...
func (m *ScenarioBuilder) WhenInjecting(injection injectors.Injector) *ScenarioBuilder {
	m.Injector = injection
	return m
}

func (m *ScenarioBuilder) WithCollector(collector collectors.Collector) *ScenarioBuilder {
...
func (m *ScenarioBuilder) WithIndicators(indicators *Indicators) *ScenarioBuilder {
